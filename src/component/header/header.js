...
function Header() {
  ...
  const renderOption = (item) => (
    <Link to={`/product-detail/${item.id}`} className="flex">
      ...
      />
      <p className="" style={{ textWrap: "wrap" }}>
    ...
    >
          ...
          <Link to={"/cart"} className="wrap-link">
            <span className="icon icon-cart relative">
              ...
              <span
                className={`${
                  cart > 0 ? "block " : "hidden "
                }absolute text-white z-10 text-center bg-red-500 
                            ${
                              cart > 10
              ...
              <div className=" text-white flex items-center text-[17px] relative">
                ...
                >
                  ...
                  <div
                    className={
                      isShowFloatLayer
                        ? " absolute left-[16px] top-[75px] z-10 bg-white shadow-[0px_0px_10px_0px_rgba(0,0,0,0.5)] w-[auto] rounded-[10px]"
                        : "hidden"
                    }
                  >
                    <ul className="">
                ...
                <Link
                  ...
                  className="auth mt-1"
                >
                  <span className="logout__span--icon ">
      ...
      <div className={`menu-header ${isAdminHomePage ? "hidden" : "block"}`}>
        <ul className="menu flex items-center w-10/12">
          <li
            className="group categories flex items-center font-medium 
                     text-white h-auto relative"
          >
            <FontAwesomeIcon
              icon={faBars}
              className="icon p-3 mt-auto mb-auto"
            ></FontAwesomeIcon>
            ...
            >
              {categories.map((category) => (
                ...
                >
                  <Link
                    to={`laptop/category=${category.slug}`}
